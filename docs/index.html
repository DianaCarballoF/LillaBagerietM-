...
<body>
    ...
    <div class="product-card">
        <img src="https://github.com/tu-usuario/tu-repositorio/raw/main/docs/images/PAN%20DE%20MUERTO.jpg" alt="Pan de Muerto">
        <h2>Pan de Muerto</h2>
        <p>This traditional Mexican bread is a seasonal favorite, ideal for celebrating Día de Muertos or any occasion.</p>
    </div>
    <div class="product-card">
        <img src="https://github.com/tu-usuario/tu-repositorio/raw/main/docs/images/ALFAJOJRES.jpg" alt="Alfajores">
        <h2>Alfajores</h2>
